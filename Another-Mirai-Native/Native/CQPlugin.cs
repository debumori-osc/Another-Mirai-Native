...
{
    public class CQPlugin : MarshalByRefObject
    {
    ...
    public static class Proxy
    {
                ...
                CurrentDomain.DoCallBack(() =>
                {
                    switch (ApiName)
                    {
                        ...
                        case FunctionEnums.GroupMemberDecrease:
                            ...
                            break;
                        case FunctionEnums.GroupMemberIncrease:
                        ...
                        case FunctionEnums.FriendRequest:
                            ...
                            break;
                        case FunctionEnums.GroupAddRequest:
                            ...
                            break;
                        case FunctionEnums.StartUp:
                            if (Startup == null)
                            { returnValue = -1; break; }
                            returnValue = Startup();
                            break;
                        case FunctionEnums.Exit:
                            if (Exit == null)
                            { returnValue = -1; break; }
                            returnValue = Exit();
                            break;
                        case FunctionEnums.Enable:
                            if (Enable == null)
                            { returnValue = -1; break; }
                            returnValue = Enable();
                            break;
                        case FunctionEnums.Disable:
                            if (Disable == null)
                            { returnValue = -1; break; }
                            returnValue = Disable();
                            break;
        ...
        public static int CallFunction(IntPtr dll, FunctionEnums api, params object[] args)
        {
        ...
        {
            var c = PluginManagment.Instance.AppDomains[hLib];
